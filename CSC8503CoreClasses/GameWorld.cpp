...
bool GameWorld::RaycastLevel(Ray& r, int rayLevel, RayCollision& closestCollision, bool closestObject, GameObject* ignoreThis) const {
	//New raycast to check only for matching ray levels
	RayCollision collision;
